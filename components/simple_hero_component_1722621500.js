...
*/
Vue.component("simple_hero_component_1722621500", {
    template: `
        <section id="hero-section" class="bg-gradient-to-br from-pink-400 to-purple-600 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8">
                    ...
                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-pink-100 lg:mb-8 md:text-lg lg:text-xl">Monitor and analyze new transactions as they occur on the Ethereum blockchain</p>
                    </div>

                    <div id="hero-buttons-container" class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <div id="hero-button-1-container" class="flex">
                            <a id="hero-button-1" href="https://github.com/themesberg/landwind" class="flex-1 items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-purple-900 bg-white bg-opacity-50 rounded-lg sm:w-auto hover:bg-opacity-70 focus:ring-4 focus:ring-pink-300 transition duration-300">Start Analyzing</a>
                        </div>

                        <div id="hero-button-2-container" class="flex">
                            <a id="hero-button-2" href="https://www.figma.com/community/file/1125744163617429490" class="flex-1 items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-white bg-purple-600 bg-opacity-50 rounded-lg sm:w-auto hover:bg-opacity-70 focus:outline-none focus:ring-4 focus:ring-pink-300 transition duration-300">View Demo</a>
                        </div>
                    </div>
