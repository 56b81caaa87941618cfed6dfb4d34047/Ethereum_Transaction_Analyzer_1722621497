...
*/
Vue.component("simple_footer_component_1722621500", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-white hover:text-pink-200 transition duration-300">
                            ...
                            EtherInspect - Ethereum Transaction Analysis
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-white hover:text-pink-200 transition duration-300">
                        Gain real-time insights into new Ethereum transactions with EtherInspect's advanced analytics platform. Monitor, track, and understand transaction activity across the Ethereum network.
                    </div>
                </div>
            </div>
        </footer> 
